...
<head>
    ...
    <title>Admin Panel - Add Gujju Category</title>
...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        <h1 class="top-title" style="margin-top: 70px">Add GujjuCategory</h1>

        <!-- Add Brand Form -->
        <form id="add-brand-form" action="{{ route('gujjucategory.store_gujjucategory') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-box">
                <div class="form-group">
                    <label for="brand-name">Gujju Category Name</label>
                    <input type="text" id="brand-name" name="name" required>
                </div>

                <div class="image-upload" style="margin-top: 10px;">
                    <label for="additional-images-2">Gujju Category Image</label>
            ...
            <div class="form-submit" style="gap: 20px">
                ...
                <a href="{{ route('gujjucategory.view_gujjucategory') }}" class="btn btn-info" style="height: 48px; align-content: center">Back</a>
            </div>
        </form>
