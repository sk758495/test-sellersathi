...
<head>
    ...
    <title>Admin Panel - Gujju Category</title>
    ...
    <!-- Body Part -->
        <main class="flex-grow-1 p-3" id="main-content">
            ...
            <div class="heading" style="display: flex; justify-content: space-between">
                ...
                <a href="{{ route('gujjucategory.add_gujjucategory') }}" class="btn btn-success" style="height: 30px; margin-top: 70px;">Add Gujju Category</a>
            </div>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Gujju Category List</h5>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('gujju-category.view_edit_category', $brand->id) }}" class="btn btn-warning btn-sm">Edit</a>

                                            <form action="{{ route('gujjucategory.delete_gujjucategory', $brand->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this Category?');">
                                                @csrf
                                                @method('DELETE')
