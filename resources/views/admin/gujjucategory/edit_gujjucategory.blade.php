...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        <h1 class="top-title" style="margin-top: 70px">Edit Gujju Category</h1>

        <form action="{{ route('gujju-category.update_category', $brand->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-box">
                <div class="form-group">
                    ...
                    <input type="text" id="brand-name" name="name" value="{{ old('name', $brand->name) }}" class="form-control" required>
                </div>

                <div class="image-upload" style="margin-top: 10px;">
                    <label for="image">Gujju Category Image</label>
