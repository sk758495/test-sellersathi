...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/create_category.css') }}">
    <style>
        /* Sidebar styles */
...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        ...
        <div class="heading" style="display: flex; justify-content: space-between">
            <h1 class="top-title" style="margin-top: 70px;">Add Category/Child </h1>
            <a href="{{ route('categories.index') }}" class="btn btn-success" style="height: 40px;">Back</a>
        </div>

        <!-- Add Brand Form -->
        <form id="add-brand-form" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-box">
