...
<head>
    ...
    <title>Admin Panel - Edit Child Category</title>
...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        ...
        <h1 class="top-title" style="margin-top: 70px;">Edit Child Category</h1>

        <!-- Edit Category Form -->

        <form id="edit-category-form" action="{{ route('categories.update_child', $category->id) }}" method="POST">
            @csrf
            @method('PUT') <!-- This is for sending the PUT request to update the category -->

            <div class="form-group">
                <label for="category-name">Category Name</label>
                <input type="text" id="category-name" name="name" value="{{ old('name', $category->name) }}" required class="form-control">
            </div>
