...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        <h1 style="margin-top: 70px">Add Subcategory for <span style="color: green;">{{ $brandCategory->name }}</span></h1>

        <form action="{{ route('pages.store_subcategory', $brandCategory->id) }}" method="POST">
        @csrf
        <div class="form-box">
