...
<body>
    ...
    <main class="flex-grow-1 p-3" id="main-content">
        ...
        <h1 style="margin-top: 70px">Add Brand Category for <span style="color: green;">{{ $brand->name }}</span></h1>

        <form action="{{ route('pages.store_brand_category', $brand->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-box">
                <div class="form-group">
                    <label for="name">Add Brand Category Name</label>
            ...
            <div class="form-submit">
                <button type="submit">Save Brand Category</button>
            </div>
        </form>
