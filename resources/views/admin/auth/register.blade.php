        ...
        <div class="login-form">
            ...
            <form method="POST" action="{{ route('admin.register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="phone" class="form-control" id="phone" name="phone" placeholder="Enter your phone" value="{{ old('phone') }}" required>
                    <div class="invalid-feedback">
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.login') }}" class="text-muted">Already registered?</a>
