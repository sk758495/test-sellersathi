        ...
        <main id="main-content" class="p-3">
            ...
            <div style="display: flex; justify-content: space-between; width: 100%; padding: 10px;">
                ...
                <button class="btn btn-success mb-3">
                    <a href="{{ route('admin.products.create') }}" style="text-decoration: none; color: white;">Add New Product</a>
                </button>
            </div>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead class="table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ asset('storage/' . $product->main_image) }}" class="img-fluid" alt="{{ $product->product_name }}"  style="width: 100px; height: 80px;">
                                    </td>
                                    <td>{{ $product->sku }}</td>
                                    ...
                                    <td><a href="{{ route('admin.products.view_product_details', ['id' => $product->id]) }}" style="text-decoration: none; ">View</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                    </table>
