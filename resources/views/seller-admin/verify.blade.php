<!-- resources/views/seller-admin/verify.blade.php -->
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <h2 class="text-center">Enter OTP for Email Verification</h2>

        <form action="{{ route('seller-admin.verify', ['id' => $sellerAdmin->id]) }}" method="POST">
            @csrf
